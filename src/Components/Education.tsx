    ...
    >
      <div className="border shadow-[0_0_10px_0_#64FFDA50] hover:-translate-y-2 transition transform duration-300 ease-in-out flex flex-col gap-2 border-primaryColor p-4 rounded-2xl sm-mx:p-2">
        <div className="flex gap-2 items-center">
          {/* <img className="rounded-lg w-16 md-mx:w-14" src={item.image} alt="Institution" /> */}
...
const Education = () => {
  ...
  return (
    <div className="px-16 lg:px-0 mx-20 md-mx:px-6 sm-mx:px-2 lg-mx:mx-0 my-10 mb-28 font-mono" id="Education">
      <h1 className="text-4xl sm-mx:text-3xl xs-mx:text-2xl  mb-10 font-bold text-center text-primaryColor">Education</h1>
