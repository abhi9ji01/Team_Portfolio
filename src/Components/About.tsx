...
import profile from "../assests/image.jpg";
  ...
  return (
    <>
      <div
        ...
        className="mt-28 flex relative overflow-hidden justify-around items-center font-mono px-10 py-14 lg:py-20  sm-mx:px-4 xs-mx:px-2 xs-mx:py-6 h-fit lg-mx:justify-between bs-mx:flex-wrap bs-mx:flex-col-reverse bs-mx:!overflow-visible bs-mx:gap-6 md-mx:px-6"
      >
        {/* <Particles
          ...
          refresh
        /> */}
        <div className="bs:ml-10 bs:w-3/5 flex flex-col lg-mx:gap-3 lg:-mt-20 xs-mx:pt-10 pt-10 bs-mx:items-center">
