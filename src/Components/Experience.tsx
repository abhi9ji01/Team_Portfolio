...
const Experience = () => {
    ...
    return <div className="px-16 lg:px-0 mx-20 md-mx:px-6 sm-mx:px-2 lg-mx:mx-0 my-10 mb-28 font-mono" id="Experience">
        <h1 className="text-4xl sm-mx:text-3xl xs-mx:text-2xl  mb-10 font-bold text-center text-primaryColor">Experience</h1>
